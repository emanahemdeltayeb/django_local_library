...
class BorrowedBooksByUserListView(LoginRequiredMixin,generic.ListView):
    """Generic class-based view listing books on loan to all user's in group librians."""
    model = BookInstance
    template_name ='catalog/borrwoedList.html'
    paginate_by = 10
...
# Authors (update , delete , create)Views: 
...
# Books (create , update , delete) View:
